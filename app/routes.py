...
from . import mongo
from .ikea_db.mongodb import add_user, build_stock, get_all_items, insert_product, delete_One_Item, update_One_Item, build_product, build_location, build_pricing, get_recent_items
from .ikea_db.mongodb import login_user, count_total_items, count_per_category, count_per_name, get_manage_items, search_items, get_low_stock, find_by_product_name, find_with_include_projection, find_with_exclude_projection, find_by_category_with_include, find_by_category_with_exclude
...
def all_items():
    ...
    return render_template("all_items.html", items=items, view_by=view_by)
